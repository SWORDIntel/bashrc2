	#!/bin/bash
	# Shamelessly ripped from the work of a much greater man,then durandal jacked it and i traded #it for some crack...then here we are
...
if [ -f "./sync.sh" ]; then
    ...
    echo "sync.sh not found in the current directory."
fi
	done
